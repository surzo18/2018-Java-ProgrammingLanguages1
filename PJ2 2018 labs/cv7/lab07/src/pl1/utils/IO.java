...
//== OSTATNI NESOUKROME METODY TRIDY ===========================================
     ...
     *
     * @param ms   Pocet milisekund, po nez se ma cekat.
     */
    ...
    {
        return RemoveDiacritics.text(text);
    }
     ...
     */
    public static void windowsOn( int x, int y )
    {
        positionOfWindows = new Point( x, y );
    }
     ...
     *
     * @param question   Zobrazovany text otazky.
     * @return <b>{@code true}</b> Odpovedel-li uzivatel <b>ANO</b>,
     *         <b>{@code false}</b> odpovedel-li <b>NE</b>
     */
    public static boolean agreement( Object question )
    {
     ...
     *
     * @param message        Text, ktery se uzivateli zobrazi.
     * @param defaultValue   Implicitni hodnota.
     * @return Uzivatelem zadana hodnota, resp. potvrzena implicitni hodnota.
     */
    public static double enter( Object message, double defaultValue )
    {
        return Double.parseDouble( enter( message, ""+defaultValue ).trim() );
    }
     ...
     *
     * @param request     Text, ktery se uzivateli zobrazi.
     * @param intDef   Implicitni hodnota.
     * @return Uzivatelem zadana hodnota, resp. potvrzena implicitni hodnota.
     */
    public static int enter( Object request, int intDef )
    {
        return Integer.parseInt( enter( request, ""+intDef ).trim() );
    }
     ...
     *
     * @param request        Text, ktery se uzivateli zobrazi.
     * @param stringDef   Implicitni hodnota.
     * @return Uzivatelem zadana hodnota, resp. potvrzena implicitni hodnota.
     */
    public static String enter( Object request, String stringDef )
    {
        JOptionPane jop = new JOptionPane(
                              request,
                              JOptionPane.QUESTION_MESSAGE,   //Message type
        ...
        jop.setInitialSelectionValue(stringDef);
        processJOP(jop);
    ...
    private static void processJOP( JOptionPane jop )
    {
        ...
        jd.addWindowListener( new WindowAdapter()
        {
            ...
            public void windowDeactivated(WindowEvent e) {
                positionOfWindows = jd.getLocation();
                if( jd.isShowing() ) {
                    return;
                }else{
                    jd.dispose();
        ...
        jd.setModal( false );
        jd.setVisible( true );
        jd.setLocation( positionOfWindows  );
